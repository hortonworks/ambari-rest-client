environments {
    jenkins {
        ...
        metadata = "https://s3-eu-west-1.amazonaws.com/maven.sequenceiq.com/release/com/sequenceiq/ambari-client/maven-metadata.xml"
    }
    ...
    local {
        ...
        metadata = "https://s3-eu-west-1.amazonaws.com/maven.sequenceiq.com/releases/com/sequenceiq/ambari-client/maven-metadata.xml"
    }
}
