...
trait UserService extends CommonService {
   ...
   */
  def createUser(String user, String password, boolean admin) throws URISyntaxException, ClientProtocolException, HttpResponseException, IOException {
   ...
   */
  def deleteUser(String user) throws URISyntaxException, ClientProtocolException, HttpResponseException, IOException {
   ...
   */
  def getUser(String user) throws AmbariConnectionException {
   ...
   */
  def grantAdminPrivilege(String user, boolean grant) throws URISyntaxException, ClientProtocolException, HttpResponseException, IOException {
   ...
   */
  def setUserActive(String user, boolean active) throws URISyntaxException, ClientProtocolException, HttpResponseException, IOException {
